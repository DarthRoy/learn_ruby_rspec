...
require "temperature" # signifie qu'il va chercher le fichier  du même nom

describe "temperature conversion functions" do # va vérifier différents comportements

  describe "#ftoc" do # va valider les 4 méthodes du dessous, soit les 4 comportements ci-dessous
