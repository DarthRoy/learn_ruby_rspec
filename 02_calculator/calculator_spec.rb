...
# # Bonus
#
# There are also some bonus exercises for when you finish the regular ones.
#The bonus round will help teach you test-driven *development*, not simply test-guided *learning*.
#
...
describe "#multiply" do
  ...
  it "multiplies two other numbers" do
    expect(multiply(5, 5)).to eq(25)# one other test here, don't forget do end ;)
  end

  it "multiplies two other numbers, one of them being 0" do
      expect(multiply(5, 0)).to eq(0) # one last test, with 0 in it
    end
end
